                    ...
                    <ul className="menu menu-horizontal px-1 gap-1">
                        ...
                        {!user?.uid ?
                            <div className="dropdown  dropdown-end">
                                ...
                                <ul tabIndex={0} className="mt-3 p-2 shadow menu menu-compact dropdown-content bg-base-100  dark:bg-slate-400 dark:text-white rounded-box w-32 ">
                                    <li className='mb-2'>
                                        <NavLink style={{ width: "100%" }} to='/login'>
                                            Login
                                        </NavLink>
                                    </li>
                                    <li><NavLink style={{ width: "100%" }} to='/register'>Register</NavLink></li>
                                </ul>
                            </div>
                            :
                            <div className="dropdown dropdown-end  tooltip tooltip-left" data-tip={user?.displayName}>
                                ...
                                <ul tabIndex={0} className="mt-3 p-2 shadow menu menu-compact dropdown-content bg-base-100  dark:bg-slate-400 dark:text-white rounded-box w-32">
                                    <li>
                                        <NavLink style={{ width: "100%" }} to='/profile' className="justify-between">
                                            Profile
                                        </NavLink>
                                    </li>
                                    <li><NavLink style={{ width: "100%" }} onClick={handleLogout}>Logout</NavLink></li>
                                </ul>
                            </div>
                        }
                    </ul>
